        ...
        >
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    {/* Contact Info */}
                    <div className="bg-black/40 rounded-md p-6 sm:p-10 flex flex-col justify-center space-y-6">
                        <div>
                            <h3 className="text-xl font-semibold text-[#cfa165] mb-2">Phone</h3>
                            <p className="text-sm text-gray-200">+20 010 2517 8918</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-200">3481 Melrose Place, Los Angeles</p>
                        </div>
                    </div>
                </div>
            </div>
